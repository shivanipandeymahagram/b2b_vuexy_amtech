...
(function () {
  ...
  // --------------------------------------------------------------------
  const revenueGeneratedE1 = document.querySelector('#revenueGenerated1'),
    revenueGeneratedConfig1 = {
      chart: {
        height: 90,
        type: 'area',
        parentHeightOffset: 0,
  ...
  if (typeof revenueGeneratedE1 !== undefined && revenueGeneratedE1 !== null) {
    const revenueGenerated1 = new ApexCharts(revenueGeneratedE1, revenueGeneratedConfig1);
    revenueGenerated1.render();
  }
...
if (typeof revenueGeneratedE2 !== undefined && revenueGeneratedE2 !== null) {
  const revenueGenerated2 = new ApexCharts(revenueGeneratedE2, revenueGeneratedConfig2);
  revenueGenerated2.render();
}


const revenueGeneratedE3 = document.querySelector('#revenueGenerated3'),
revenueGeneratedConfig3 = {
  chart: {
    height: 90,
    type: 'area',
    parentHeightOffset: 0,
...
const revenueGenerated3 = new ApexCharts(revenueGeneratedE3, revenueGeneratedConfig3);
revenueGenerated3.render();
}
