...
class Microatmreport extends Model
{
    ...
    protected $fillable = ['mobile' ,'aadhar', 'txnid', 'api_id', 'amount', 'charge', 'bank', 'payid', 'refno', 'mytxnid', 'terminalid', 'authcode', 'balance', 'status', 'type', 'remark', 'rtype', 'transtype', 'aepstype', 'TxnMedium', 'user_id', 'credited_by','wid','wprofit','mdid','mdprofit','disid','disprofit', 'provider_id','option1','option2','option3'];
