...
<body class="iq-page-menu-{{$themeStyle}}">
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <!-- Menu -->
            @include('theme_1.layouts.sidebar')
            <!-- End Menu -->
            ...
            <div class="layout-page">
                ...
                <!-- Topbar -->
                @include('theme_1.layouts.topbar')
                <!-- End Topbar -->

                <!-- Content wrapper -->
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        @include('theme_1.layouts.pageheader')
                        @yield('theme_1_content')
                    </div>
                    <!-- Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Wallet Load</h5>
