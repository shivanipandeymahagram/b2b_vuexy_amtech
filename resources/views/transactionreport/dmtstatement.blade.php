                ...
                <table width="100%" class="table border-top mb-5" id="datatable" role="grid" aria-describedby="user-list-page-info">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td scope="col">
                                <div><small>Name - JOSEPHDAS</small></div>
                                <div><small>Account - 919010055333872</small></div>
                                <div><small>Bank - Axis Bank</small></div>
                            </td>
                            <td scope="col">
                                <div><small>Remitter - shivani (7208822572)</small></div>
                                <div><small>Bank Ref - You have Insufficent balance</small></div>
                                <div><small>Txnid - RP5441407044</small></div>
                                <div><small>Payid - null</small></div>
                            </td>
                            <td scope="col">
                                <div><small>Amount - 100 ₹/-</small></div>
                                <div><small>Charge - 10 ₹/-</small></div>
                                <div><small>Profit - 0 ₹/-</small></div>
                                <div><small>GST - 0 ₹/-</small></div>
                            </td>
                            <td scope="col">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="javascript:void(0);">Print Invoice</a></li>
                                        ...
                                        <li><a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#complaintModal">GetRefund</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog  modal-simple modal-edit-user">
        <div class="modal-content p-md-5">
            <div class="modal-body">
                ...
                <form id="transferForm" action="{{route('dmtstatement')}}">
                    <div class="modal-body">
                        <div class="row">
