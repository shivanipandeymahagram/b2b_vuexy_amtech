            ...
            <form class="commissionForm" method="post" action="{{ route('resourceupdate') }}">
                <div class="modal-body">
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                            @if(!empty($ebillOperatorOffiline))
            ...
            <form class="commissionForm" method="post" action="{{ route('resourceupdate') }}">
                <div class="modal-body">
                    ...
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                            @if(!empty($postpaidOperatorOperator))
